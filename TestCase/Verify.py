...
class Verify(ParametrizedTestCase):
    def login(self):
    ...
    def testAmyAdd(self):
        self.login()
        app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../Yamls/InfoBase/Verify.yaml"),
               "caseName": sys._getframe().f_code.co_name}
    ...
    @classmethod
    def setUpClass(cls):
        super(Verify, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(Verify, cls).tearDownClass()
