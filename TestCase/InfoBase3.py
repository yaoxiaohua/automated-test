...
class InfoBaseTest3(ParametrizedTestCase):
    def login(self):
    ...
    def testBasicJDAdd(self):
        self.login()
        app = {"logTest": self.logTest, "driver": self.driver, "path": PATH("../Yamls/InfoBase/InfoBase3.yaml"),
               "caseName": sys._getframe().f_code.co_name}
    ...
    @classmethod
    def setUpClass(cls):
        super(InfoBaseTest3, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        super(InfoBaseTest3, cls).tearDownClass()
